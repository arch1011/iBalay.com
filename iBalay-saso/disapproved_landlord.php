...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Disapproved Accounts</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="/iBalay.com/iBalay-saso/index.php">Home</a></li>
          <li class="breadcrumb-item active">Disapproved Account Lists</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
...
$sqlOwners = "SELECT owner_id, name, contact_number, email, location FROM owners WHERE approval_status = 2";
...
if ($resultOwners && mysqli_num_rows($resultOwners) > 0) {
    ...
    <div class="col-12">
        <div class="card recent-sales overflow-auto">
            <div class="card-body">
                <h5 class="card-title">Landlords Infroamtion</h5>
    ...
    echo '<p>No Landlords Information Records.</p>';
}
