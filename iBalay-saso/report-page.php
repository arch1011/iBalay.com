        ...
        <table class="table datatable">
          <thead>
            <tr>
              ...
              <th>Action</th>
                                      <th>Acknowledge</th> <!-- Add this column header -->
            </tr>
          </thead>
          <tbody>
            ...
            $reportQuery = "SELECT report.*, room.RoomNumber, tenant.FirstName, tenant.LastName, room.BoardingHouseName, room.Barangay, room.Municipality, owners.name AS ownerName
                            FROM report
                            JOIN room ON report.RoomID = room.RoomID
            ...
            ?>
                <tr>
                  <td><?php echo $report['BoardingHouseName']; ?></td>
    ...
    <button id="acknowledgeBtn<?php echo $report['ReportID']; ?>" class="btn btn-<?php echo $report['Acknowledge'] ? 'success' : 'primary'; ?>" onclick="acknowledgeReport(<?php echo $report['ReportID']; ?>)">
        <?php echo $report['Acknowledge'] ? '<i class="bi bi-check"></i>' : 'Acknowledge'; ?>
                            ...
                            <div class="modal fade" id="viewModal<?php echo $report['ReportID']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <p>Room Number: <?php echo $report['RoomNumber']; ?></p>
                                            <p>Boarding House Name: <?php echo $report['BoardingHouseName']; ?></p>
                                            <p>Owner Name: <?php echo $report['ownerName']; ?></p>
                                            <p>Location: Brgy. <?php echo $report['Barangay']; ?>, <?php echo $report['Municipality']; ?>, Leyte</p>
                                ...
                                <div class="modal fade" id="deleteModal<?php echo $report['ReportID']; ?>" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="button" class="btn btn-danger" onclick="deleteReport(<?php echo $report['ReportID']; ?>)">Delete</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
