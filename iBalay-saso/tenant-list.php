...
// Your SQL query to get tenants with non-null OwnerID and RoomID
$sqlTenants = "SELECT * FROM tenant WHERE OwnerID IS NOT NULL AND RoomID IS NOT NULL";
