...
$sqlOwners = "SELECT owner_id, name, contact_number, email, location, warnings, close_account FROM owners WHERE approval_status = 1 AND close_account = 0";
                                        ...
                                        <td>
                                            ...
                                            <?php } else { ?>
                                                <form action="set_warning_level.php" method="post">
                                                    <input type="hidden" name="owner_id" value="<?php echo $rowOwner['owner_id']; ?>">
