...
$sqlOwners = "SELECT owner_id, name, contact_number, email, location FROM owners WHERE approval_status = 1";
                    ...
                    <tbody>
                        ...
                        while ($rowOwner = mysqli_fetch_assoc($resultOwners)) {
                            ...
                            <tr>
                                ...
                                <td>
                                        <button class="btn btn-primary btn-sm view-property-btn" data-owner-id="<?php echo $rowOwner['owner_id']; ?>">
                                            <i class="bi bi-eye"></i>
                                        </button>
                                        
                                        <button class="btn btn-success btn-sm download-report-btn" data-owner-id="<?php echo $rowOwner['owner_id']; ?>">
                                            <i class="bi bi-download"></i> 
                                        </button>
                                    
                                    <!-- add when neccesary
                                    <a href="https://ibalay-project.000webhostapp.com/iBalay.com/iBalay-saso/map.php" class="btn btn-info btn-sm">
                                        <i class="bi bi-map"></i> Go to Map
                                    </a> -->
                                    
                                    <button class="btn btn-primary view-documents-btn" data-owner-id="<?php echo $rowOwner['owner_id']; ?>"> <i class="bi bi-file-text"></i></button>
        ...
        document.addEventListener("DOMContentLoaded", () => {
            ...
            viewPropertyButtons.forEach(button => {
                button.addEventListener('click', () => {
                    ...
                    // Store owner ID in session storage
                    sessionStorage.setItem('selectedOwnerId', ownerId);

                    // Redirect to Owner-property.php
