...
<head>
  ...
  <title>Users / Profile - iBalay Owner</title>
  <!-- Favicons 
...
// Fetch user data from the database based on $ownerID
$query = "SELECT username, name, location, contact_number, email, photo FROM owners WHERE owner_id = $ownerID";
...
if (mysqli_num_rows($result) > 0) {
  ...
  $photoUrl = $userData['photo']; // Add this line to fetch the photo URL
$uploads = '/iBalay.com/uploads/photos/' . basename($photoUrl);
}
?>
      ...
      <div class="row">
        <div class="col-xl-4">
            ...
            <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
              <img src="<?php echo $uploads; ?>" alt="Profile" class="rounded-circle">
              <h2><?php echo $name; ?></h2>
            </div>
          </div>
                  ...
                  <form action="update_user_profile.php" method="post" enctype="multipart/form-data">
                      <div class="row mb-3">
                          ...
                          <div class="col-md-8 col-lg-9">
                              <img src="<?php echo '/iBalay.com/uploads/photos/' . basename($photoUrl); ?>" alt="Profile">
                              <div class="pt-2">
                                  <label for="imageUpload" class="btn btn-primary btn-sm" title="Upload new profile image">
                      ...
                      <input type="hidden" name="ownerID" value="<?php echo $_SESSION['owner_id']; ?>">
